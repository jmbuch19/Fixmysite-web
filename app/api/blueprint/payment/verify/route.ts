 ...
 *
 * Slice 2.3 will add the auto-email path here (PDF render + Resend
 * delivery to owner_email). For Slice 2.2 the verify path just flips
 * the row and lets the client redirect to /full.
 */
